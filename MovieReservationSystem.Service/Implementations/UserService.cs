...
namespace MovieReservationSystem.Service.Implementations
{
    public class UserService : IUserService
    {
        ...
        #region Constructors
        public UserService(UserManager<User> userManager, IHttpContextAccessor contextAccessor, IEmailService emailService, IUrlHelper urlHelper, AppDbContext appDbContext)
        {
        ...
        #endregion
        public async Task SendConfirmUserEmailToken(User user)
        {
            var code = await _userManager.GenerateEmailConfirmationTokenAsync(user);
            var requestAccessor = _contextAccessor.HttpContext.Request;

            var returnURL = requestAccessor.Scheme + "://" + requestAccessor.Host + _urlHelper.Action("ConfirmEmail", "Users", new { userId = user.Id, code = code });
        ...
        public async Task ConfirmUserEmail(User user, string code)
        {
